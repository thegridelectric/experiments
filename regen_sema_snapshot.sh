...
REPO_ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"  # script sits at the experiments top
...
PACKAGE_NAME="gwexp"
SEED="${REPO_ROOT}/src/gwexp/sema_seed_request.yaml"
VENDOR_DIR="${REPO_ROOT}/src/gwexp/sema"
